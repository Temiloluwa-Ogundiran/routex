...
from api.views.routerView import router_control_router
from api.v1 import initialize, interswitch_checkout, webhooks, payout, verify_transaction, banks, cryptos
router = APIRouter()
if not IS_V1: #Dashboard only paths
    ...
    router.include_router(router_control_router, tags=['Router'])
...
router.include_router(interswitch_checkout.interswitch_checkout_router, tags=['V1'])
